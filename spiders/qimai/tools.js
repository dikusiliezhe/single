...
function beforeRequest(t) {
  ...
  s = 1079;                  // s = c[x][k][Pt] = Vue.prototype.difftime，根据组件有所不同，这里测试的页面为610
  ...
  try {
    ...
    // a = "@#/appDetail/keywordDetail@#26027511599@#3"
    //   "@#/appDetail/keywordDetail@#26521242667@#3"
    e = vf(hf(a, d));
    return e;
  } catch (t) {}
}
